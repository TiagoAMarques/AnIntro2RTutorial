...
I use this material for both my `Ecologia Numérica` and my `Modelação Ecológica` at [FCUL](https://ciencias.ulisboa.pt/en) courses [^1].
...
To start using this tutorial right away download [^2] the contents of the corresponding github [repository](https://github.com/TiagoAMarques/AnIntro2RTutorial). At a bare minimum, you should first look at the slides at `AQuikIntro2RandRStudioInQuarto.html` available at  [Rpubs](https://rpubs.com/talomarques/AnIntroToRandRStudio) [^3]
...
- `TAMsIntro2RviaRStudioTutorial.pdf`[^4]
- `dados1.csv`
- `mydatafile.txt`
