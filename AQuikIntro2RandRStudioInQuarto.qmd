---
title: "A quick introduction to R and Quarto from within RStudio"
...
```{=html}
<!--
when you republish this presentation, it shows up in chrome as
not being at this adreess, but at something like 
https://rpubs.com/talomarques/1342657
This is irrelevant and the above address will work regardless
-->
```
...
::: footer
[image source at r4stats.com](http://r4stats.com/articles/popularity/) - [different sources](https://medium.com/@tomazkastrun/r-package-updates-and-release-dates-statistics-and-another-rise-of-r-language-5125faa80eb1) provide different numbers, but overall patters are the same
:::
...
![](images/clipboard-572115993.png)

::: footer
[Check the landing page at my AnIntro2RTutorial github repos](https://github.com/TiagoAMarques/AnIntro2RTutorial)
:::

## Quarto and Dynamic Reports

![](images/clipboard-3694592128.png)

## Creating a dynamic report I

Let us create a dynamic report from scratch in Quarto via RStudio

![](images/clipboard-3780827632.png)

## Set Title and author

Let us create a dynamic report from scratch in Quarto via RStudio

## ![](images/clipboard-1885371371.png)

## Almost there

This is what you should be seeing. Check your title and name are there.

![](images/clipboard-690324205.png)
...
## ![](images/clipboard-682703654.png)
...
Your first quarto dynamic report is ready

## ![](images/clipboard-3728194723.png)
...
## ![](images/clipboard-3751131737.png)Possible outputs

- Your now have your first HTML automatically generated, obtained from compiling (=knitting) the .qmd file.
...
- For more, check e.g. the [quarto cheat sheet](https://rstudio.github.io/cheatsheets/quarto.pdf)

## Warning: command line vs .Rmd

![](extfiles/warning.png){fig-align="center"}

- When you run some code within a .qmd, it is only run in the .qmd
...
- A .qmd is not a usual script, it has both code and text. The result is a dynamic document, with Text, Code, and Ooutputs of the code
...
## Useful Quarto web resources

- An quarto template with lots of tips and trick made just for YOU [here](https://github.com/TiagoAMarques/template_4_quarto_report)

- About R Markdown, the official site [here](https://rmarkdown.rstudio.com/)
