...
This .Rmd was last compiled on `r Sys.time()`.
...
There is an extensive community revolving around R, and abundant courses, tutorials, books, blogs, list servers, etc, freely available online. We provide here a small list of these that might be particularly helpful for beginners:
...
Typically, if I am using this tutorial in a class room, the student will have been exposed to the powerpoint `Quick introduction to R and R Studio.pptx`. If you are not in a class room, you might want to take a look at it. This is alos vailable at
