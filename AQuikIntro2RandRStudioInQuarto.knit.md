...
You can get all the material by downloading and unziping the [github repository](https://tiagoamarques.github.io/AnIntro2RTutorial/) contents. See image below: press the button at the end of the red arrow, then that of the blue arrow, and finally unzip the material into a folder of your choice.

![](extfiles/downloadgit.png){.absolute top="300" left="30" width="1000" height="400"}
...
-   Try to use dynamic numbers like this one: 0.5564619 printing the mean value of 5 random Gaussian numbers. For that you need to use something like \`? mean(rnorm(5))\` (note: replace the "?" with the leter "r" so that it knows you want to run r code).
